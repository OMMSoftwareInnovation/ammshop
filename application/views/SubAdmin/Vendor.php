                            ...
                            <?php $i=1;if(!empty($VendorDetails)){
                                ...
                                <tr>
                                    ...
                                    <td>                                   
                                        ...
                                        <?php if($vendor->verified == 1){?><span class="label label-primary">Verified</span> <?php }else{?><span class="label label-warning">UnVerified</span><?php } ?>
                                    </td>
                                </tr><?php }}?>
                            </tbody>
                        </table>
...
<div class="modal fade" id="largeModalAddVendor" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form_add_vendor" id="form_add_vendor" method="post" action="<?php echo base_url();?>SubAdmin/AddVendor" enctype="multipart/form-data"> 
...
<div class="modal fade" id="largeModalEditVendor" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form_edit_vendor" id="form_edit_vendor" method="post" action="<?php echo base_url();?>SubAdmin/EditVendor" enctype="multipart/form-data"> 
...
$(document).ready(function($){
    /*$('.chkblock').on('change',function(){
        ...
        $.ajax({
            url: "<?php echo base_url();?>SubAdmin/BlokUnblockVendor",
            method:"post",
    ...
    $('.selectcity').on('change',function(){ 
        ...
        $.ajax({
            ...
            url: "<?php echo base_url();?>SubAdmin/Getarea",
            method:"post",
            data: {'cityid' : cityid},
            success: function(result)
            {
    ...
    $('#form_add_vendor').validate({        
        rules:{
            ...
            /*'txtcatid[]':{remote:{url: "<?php echo base_url();?>SubAdmin/CheckCategoryExistForCity",type:"post",
                    data:{
    ...
    $('#form_edit_vendor').validate({        
        rules:{
          /*  'edittxtcatid[]':{remote:{url: "<?php echo base_url();?>SubAdmin/EditCheckCategoryExistForCity",type:"post",
                    data:{
    ...
    $('.clsDeleteVendor').on('click',function(){
            ...
            closeOnConfirm: false
                ...
                $.ajax({
                url: "<?php echo base_url();?>SubAdmin/DeleteVendor",
                method:"post",
                data: {'vid' : vid},
                dataType: 'json',
                success: function(result)
