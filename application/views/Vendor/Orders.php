                        ...
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <select class="form-control show-tick selectpicker" data-live-search="true" id="txtorderstatusid" name="txtorderstatusid" required>
...
<script>
 $(document).ready(function($){
    ...
    $('#btnCitySubmit').on('click',function(){ 
        ...
        var orderstatus=$('#txtorderstatusid').val();
        if(cityname)
        {
            $.ajax({
                url: "<?php echo base_url();?>SubAdmin/GetCityStatusWiseOrders",
                method:"post",
                data: {'cityname' : cityname,'orderstatus' : orderstatus},
                success: function(result)
                {
