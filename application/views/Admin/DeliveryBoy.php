    ...
    <div class="modal fade" id="largeModalAddDeliveryBoy" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form class="form_add_delivery_boy" id="form_add_delivery_boy" method="post" action="<?php echo base_url();?>Admin/AddDeliveryBoy" enctype="multipart/form-data"> 
    ...
    <div class="modal fade" id="largeModalEditDeliveryBoy" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form class="form_edit_delivery_boy" id="form_edit_delivery_boy" method="post" action="<?php echo base_url();?>Admin/EditDeliveryBoy" enctype="multipart/form-data"> 
...
<script>
    $(document).ready(function($){
        ...
        $('#form_add_delivery_boy').validate({        
            rules:{
                txtmobileno:{maxlength:10,minlength:10,remote:{url: "<?php echo base_url();?>Admin/CheckMobileNoExist",type:"post",
                        data:{
        ...
        $('#form_edit_delivery_boy').validate({        
            rules:{
                edittxtmobileno:{maxlength:10,minlength:10,remote:{url: "<?php echo base_url();?>Admin/EditCheckMobileNoExist",type:"post",
                        data:{
        ...
        $('.clsDeleteDeliveryBoy').on('click',function(){
                ...
                closeOnConfirm: false
                    ...
                    $.ajax({
                    url: "<?php echo base_url();?>Admin/DeleteDeliveryBoy",
                    method:"post",
                    data: {'did' : did},
                    dataType: 'json',
                    success: function(result)
