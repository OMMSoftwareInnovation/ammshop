    ...
    <div class="row clearfix">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <form id="oldpasscheck_form" method="POST" action="<?php echo base_url();?>Admin/Updatepassword">
        ...
        $(document).ready(function($){
            ...
            $('#oldpasscheck_form').validate({
                ...
                rules:{
                    ...
                    oldpassword:{remote:{url: "<?php echo base_url();?>Admin/Checkpassword",type:"post",
                          data:{
