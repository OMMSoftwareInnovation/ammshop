        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo $this->session->userdata['Alogged_in']['Name'];?></div>
                    <div class="email"><?php echo $this->session->userdata['Alogged_in']['Email'];?></div>
                    <div class="btn-group user-helper-dropdown">
                        <i class="material-icons" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">keyboard_arrow_down</i>
                        <ul class="dropdown-menu pull-right">
                            <li><a href="<?php echo base_url();?>Admin/ChangePassword"><i class="material-icons">lock</i>Change Password</a></li>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="<?php if($this->router->method == "index" ||$this->router->method == "Admin_login_process" || $this->router->method == "Notification" || $this->router->method == "Profile"){?>active<?php }?>">
                        <a href="<?php echo base_url();?>Admin/index">
                            <i class="material-icons">home</i>
                            <span>Home</span>
                        </a>
                    </li>
                    <li class="<?php if($this->router->method == "City" || $this->router->method == "Area" || $this->router->method == "Category" || $this->router->method == "SubCategory" || $this->router->method == "QuantityType" || $this->router->method == "Quantity" || $this->router->method == "CouponCode" || $this->router->method == "SlotsOfDelivery" || $this->router->method == "ShippingCharges"){?>active<?php }?>">
                    ...
                    <li class="<?php if($this->router->method == "SubAdmin" || $this->router->method == "AddSubAdmin" || $this->router->method == "Vendor" || $this->router->method == "AddVendor" || $this->router->method == "DeliveryBoy" || $this->router->method == "AddDeliveryBoy" || $this->router->method == "Items"){?>active<?php }?>">
                        <a href="javascript:void(0);" class="menu-toggle">
                            <i class="material-icons">people</i>
                            <span>Person Master</span>
                        </a>
                        <ul class="ml-menu">
                            <li class="<?php if($this->router->method == "SubAdmin" || $this->router->method == "AddSubAdmin"){?>active<?php }?>">
                            ...
                            <li class="<?php if($this->router->method == "DeliveryBoy" || $this->router->method == "AddDeliveryBoy"){?>active<?php }?>">
                                <a href="<?php echo base_url();?>Admin/DeliveryBoy">
                                    <i class="material-icons">person</i>
                                    <span>Delivery Boy</span>
                                </a>
                            </li> 
                            <li class="<?php if($this->router->method == "Items"){?>active<?php }?>">
                    ...
                    <li class="<?php if($this->router->method == "VendorPayments" || $this->router->method == "AddVendorPayment"){?>active<?php }?>">
                        <a href="<?php echo base_url();?>Admin/VendorPayments">
                            <i class="material-icons">attach_money</i>
                            <span>Vendor Payments</span>
                        </a>
                    </li>   
                    <li class="<?php if($this->router->method == "Orders" || $this->router->method == "CurrentOrders" || $this->router->method == "RejectedOrders"){?>active<?php }?>">
                        <a href="javascript:void(0);" class="menu-toggle">
                            <i class="material-icons">people</i>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li class="<?php if($this->router->method == "CurrentOrders"){?>active<?php }?>">
                                <a href="<?php echo base_url();?>Admin/CurrentOrders">
                                    <i class="material-icons">add_shopping_cart</i>
                                    <span>Current Orders</span>
                                </a>
                            </li> 
                            <li class="<?php if($this->router->method == "RejectedOrders"){?>active<?php }?>">
                                <a href="<?php echo base_url();?>Admin/RejectedOrders">
                                    <i class="material-icons">remove_shopping_cart</i>
                    ...
                    <li class="<?php if($this->router->method == "WalletMoney" || $this->router->method == "AddWalletMoney"){?>active<?php }?>">
                        <a href="<?php echo base_url();?>Admin/WalletMoney">
                            <i class="material-icons">money</i>
                            <span>Wallet Money</span>
                        </a>
                    </li>   
                    <li class="<?php if($this->router->method == "AssignedCoupons" || $this->router->method == "AddAssinedCouponCode"){?>active<?php }?>">
                        <a href="<?php echo base_url();?>Admin/AssignedCoupons">
                            <i class="material-icons">money</i>
                            <span>Assign Coupon Code</span>
                        </a>
                    </li>  
                    <li class="<?php if($this->router->method == "SellReport" ){?>active<?php }?>">
                        <a href="javascript:void(0);" class="menu-toggle">
                            <i class="material-icons">done_all</i>
                            <span>Reports</span>
                        </a>
                        <ul class="ml-menu">
                            <li class="<?php if($this->router->method == "SellReport"){?>active<?php }?>">
                                <a href="<?php echo base_url();?>Admin/SellReport">
                                    <i class="material-icons">money</i>
